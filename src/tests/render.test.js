...
const pageSnapshot = readFileSync('./src/tests/page.snapshot.html', { encoding: 'utf-8' });
const postSnapshot = readFileSync('./src/tests/post.snapshot.html', { encoding: 'utf-8' });
